var app = angular.module('app').controller("EventsController", function ($scope, $http, $modal, feedback) {
    var vm = this;

    $scope.title = "Wydarzeia";
    ...
    loadEvents = function () {
        $http.get('rs/event').success(function (data) {
