var app = angular.module('app').controller("GroupsController", function ($scope, $http, $modal, feedback) {
    var vm = this;
    ...
    loadGroups = function () {
        $http.get('rs/group').success(function (data) {
