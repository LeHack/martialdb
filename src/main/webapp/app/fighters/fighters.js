var app = angular.module('app').controller("FightersController", function ($scope, $http, $modal, feedback) {
    var vm = this;
    ...
    $scope.loadGridData = loadFighters;
...
var app = angular.module('app').controller("editRowCtrl", function ($modalInstance, $scope, $http, $modal, grid, row) {
    var vm = this;
  
    vm.schema = $scope.editFormSchema;
    vm.form = $scope.editForm;
...
var app = angular.module('app').controller("removeRowCtrl", function ($modalInstance, $scope, $http, $modal, grid, row) {
    var vm = this;
